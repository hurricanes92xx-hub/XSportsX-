...
ALIASES={
 'MIAMI OH REDHAWKS':['MIAMI REDHAWKS','MIAMI OH'], 'TEXAS A M AGGIES':['TEXAS A M','TEXAS AM'], 'TEXAS A M':['TEXAS A M','TEXAS AM'],
 'LOUISIANA RAGIN CAJUNS':['LOUISIANA','LOUISIANA LAFAYETTE'], 'GARDNER WEBB':['GARDNER WEBB','GARDNER WEBB RUNNIN BULLDOGS'], 'GARDNER WEBB RUNNIN BULLDOGS':['GARDNER WEBB'],
 'AR PINE BLUFF':['ARKANSAS PINE BLUFF','ARKANSAS PINE BLUFF GOLDEN LIONS'], 'ARKANSAS PINE BLUFF GOLDEN LIONS':['ARKANSAS PINE BLUFF'],
 'NC A T':['NORTH CAROLINA A T','NORTH CAROLINA A T AGGIES'], 'NORTH CAROLINA A T AGGIES':['NORTH CAROLINA A T','NC A T'],
 'UT RIO GRANDE':['UT RIO GRANDE VALLEY','UT RIO GRANDE VALLEY VAQUEROS'], 'UT RIO GRANDE VALLEY VAQUEROS':['UT RIO GRANDE VALLEY','UT RIO GRANDE'],
 'N WESTERN ST':['NORTHWESTERN STATE','NORTHWESTERN STATE DEMONS'], 'EAST TEXAS A M':['EAST TEXAS A M','EAST TEXAS A M LIONS'], 'EAST TEXAS A M LIONS':['EAST TEXAS A M'],
 'WILLIAM MARY':['WILLIAM MARY','WILLIAM MARY TRIBE'], 'WILLIAM MARY TRIBE':['WILLIAM MARY'], 'BETHUNE COOKMAN WILDCATS':['BETHUNE COOKMAN','BETHUNE COOKMAN WILDCATS'],
 'PRAIRIE VIEW A M PANTHERS':['PRAIRIE VIEW A M','PRAIRIE VIEW A M PANTHERS'], 'ALABAMA A M BULLDOGS':['ALABAMA A M','ALABAMA A M BULLDOGS'],
 'ST THOMAS TOMMIES':['ST THOMAS','ST THOMAS TOMMIES'], 'STEPHEN F AUSTIN LUMBERJACKS':['STEPHEN F AUSTIN','STEPHEN F AUSTIN LUMBERJACKS'],
 'CHICAGO STATE COUGARS':['CHICAGO STATE','CHICAGO STATE COUGARS'], 'VIRGINIA LYNCHBURG DRAGONS':['VIRGINIA LYNCHBURG','VIRGINIA LYNCHBURG DRAGONS'],
 'KENTUCKY CHRISTIAN KNIGHTS':['KENTUCKY CHRISTIAN','KENTUCKY CHRISTIAN KNIGHTS'], 'CENTRAL STATE OH MARAUDERS':['CENTRAL STATE OH','CENTRAL STATE OH MARAUDERS'],
 'ARKANSAS BAPTIST BUFFALOES':['ARKANSAS BAPTIST','ARKANSAS BAPTIST BUFFALOES'], 'WEBBER INTERNATIONAL WARRIORS':['WEBBER INTERNATIONAL','WEBBER INTERNATIONAL WARRIORS'],
 'LANE DRAGONS':['LANE','LANE DRAGONS'], 'MILES COLLEGE GOLDEN BEARS':['MILES COLLEGE','MILES COLLEGE GOLDEN BEARS'], 'TEXAS WESLEYAN RAMS':['TEXAS WESLEYAN','TEXAS WESLEYAN RAMS'],
 'THOMAS MORE COLLEGE SAINTS':['THOMAS MORE','THOMAS MORE COLLEGE','THOMAS MORE COLLEGE SAINTS'], 'DICKINSON PA RED DEVILS':['DICKINSON PA','DICKINSON PA RED DEVILS'],
 'LINCOLN PA LIONS':['LINCOLN PA','LINCOLN PA LIONS'], 'POINT UNIVERSITY SKYHAWKS':['POINT UNIVERSITY','POINT UNIVERSITY SKYHAWKS'],
 'RIO GRANDE RED STORM':['RIO GRANDE','RIO GRANDE RED STORM'], 'MOREHOUSE COLLEGE MAROON TIGERS':['MOREHOUSE COLLEGE','MOREHOUSE COLLEGE MAROON TIGERS'], 'UFTL EAGLES':['UFTL','UFTL EAGLES']}
