...
const child=spawn(process.execPath,["sports-router.js"],{env:process.env,stdio:"inherit"});
child.on("exit",code=>process.exit(code??0));
child.on("error",err=>{console.error("XSportsX backend error",err);process.exit(1)});
